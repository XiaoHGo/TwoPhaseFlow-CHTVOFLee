...
Description
    An multiregion vOF-conjuagte-heat-transfer solver supporting algrebraic and geometric VOF, 
    to resolve energy jump phase change model on surface, 
    the liquid and vapor phase are assumed to be isothermal.
Authors
    Henning Scheufler
...
Application
    multiRegionBoilingFlow

Description
    An multiregion vOF-conjuagte-heat-transfer solver supporting algrebraic and geometric VOF,
    Supporting heat transfer within phase,
    Supporting Lee-type phase change model.
